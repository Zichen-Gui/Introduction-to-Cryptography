...
| 12      | - Universal hash functions <br> - Security of universal hash functions <br> - The CBC and cascading constructions are computational UHFs <br> - UHFs using polynomials | - Boneh&Shoup 7.1-7.2  |
